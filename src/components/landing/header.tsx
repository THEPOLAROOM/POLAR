...
//    with fixed spacing directly from `inset-0`. This is safe/correct
//    without any separate box computation because CarouselRow's own
//    box (see carousel-row.tsx) is now always locked to the artwork's
//    exact 13:6 ratio at width:100% — the row IS the artwork's
//    displayed box, so `inset-0` here already lands exactly on it.
...
//    locked ratio, which the row itself now enforces. `logoVariant`
