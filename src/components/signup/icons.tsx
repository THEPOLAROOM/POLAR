// Shared icon set for both /signup/client and /signup/barber — moved
// here (superseding src/app/signup/client/icons.tsx, kept on disk,
// unreferenced) so the new Barber redesign can reuse the exact same
// glyphs (envelope/lock/eye/chevron/pin) instead of duplicating them,
// plus two new ones (Person, Scissors) for Barber's section headers.
...
export function ScissorsIcon({ className }: IconProps) {
  return <Icon className={className}><circle cx="6.5" cy="6.5" r="2.3" /><circle cx="6.5" cy="17.5" r="2.3" /><path d="M8.3 8 20 19M8.3 16 20 5" /></Icon>;
}
