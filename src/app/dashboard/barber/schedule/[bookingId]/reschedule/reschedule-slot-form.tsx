...
import { rescheduleBookingAsBarber } from "@/lib/actions/barber-bookings";
...
export function RescheduleSlotForm({
  ...
  function handleClick() {
    ...
    // back to the schedule, so there is no success state here.
    startTransition(async () => {
      const result = await rescheduleBookingAsBarber(formData);
      setPending(false);
