...
// for now; a real scrollable Privacy Policy UI will be layered into
// this same box (via FooterPageShell's `children`) in a follow-up
// pass. Route/page structure is unchanged, so /legal/privacy keeps
// working exactly as before from every existing link (footer,
