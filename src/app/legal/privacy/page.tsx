...
// Approved final "Privacy Policy" mastered design (PRIVACY-POLICY.png,
// native 5769x2663 — same canvas the rest of this footer-page family
// uses), rendered byte-for-byte via the shared FooterPageShell, no
// crop/stretch/redesign. Replaces the earlier shared
// FOOTER-BACKGROUND.png placeholder now that a page-specific title has
// been supplied. Route/page structure is unchanged, so /legal/privacy
// keeps working from every existing link (footer, signup/barber's
// acceptance checkbox).
//
...
// The invisible scroll region for the future Privacy Policy text.
...
// this box out of the source artwork. Identical box to Terms &
// Conditions, since both pages share the same background artwork and
